...
fn count_bits_puzzle1<'a>(
    config: &Config,
    propulsion: &'a mut /*'a */ Propulsion,
) -> Result<&'a Propulsion, std::io::Error> {
...
fn count_bits_puzzle2<'a>(
    ...
    fn recurse_leading_digit_select(
        input_vector: Vec<String>,
        profile: &str,
        digit_index_option: Option<i32>,
    ) -> Vec<String> {
